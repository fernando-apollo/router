...
impl JSONSelection {
    ...
    fn parse_span(input: Span) -> ParseResult<Self> {
        match get_connect_spec(&input) {
            ...
            ConnectSpec::V0_5 => Self::parse_span_v0_5(input),
        }
    }
    ...
    fn parse_span_v0_5(input: Span) -> ParseResult<Self> {
        Self::parse_span_v0_4(input)
    }
                    ...
                    Self::parse_spread_type_name(after_spread.clone())
            {
                ...
                return Ok((
                    ...
                    Self {
                        ...
                        path: path_value(PathSelection::empty()),
                    },
                ));
            }
...
impl SpreadArgs {
    ...
    fn parse(input: Span) -> ParseResult<Self> {
        ...
        input = spaces_or_comments(input)?.0;
        let (input, close_paren) = ranged_span(")").parse(input)?;
